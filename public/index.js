$(document).ready(() => {
    ...
    const selectOption = $("#channel")
    
    
    // Fetch Data
 
    const fetchData = (queryChannel) => {
 ...
 const selectOptionFuction = () => {
       selectOption.on("input", (e) =>{
        let queryChannel = e.target.value
        fetchData(queryChannel)
    })
 }
